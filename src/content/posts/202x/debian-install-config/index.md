...
![选择安装类型](./images/debian-install-710246.webp)

### 2. 选择语言

选择「安装向导」和系统中要使用的语言，然后点击「Continue」继续。国内的小伙伴选择「**中文（简体）**」即可。

![选择语言](./images/debian-install-201960.webp)

### 3. 选择你的位置

选择你所在的地理位置，系统会以此自动为 Debian 13 设置时区。

![选择位置](./images/debian-install-763428.webp)

### 4. 配置键盘

在列表中选择与你「实体键盘」相匹配的键盘布局，然后点击「继续」。

![配置键盘](./images/debian-install-596146.webp)
...
![](./images/debian-install-748551.webp)
...
![](./images/debian-install-264800.webp)
...
![](./images/debian-install-862048.webp)

3. 输入网关 IP 地址，然后点击「继续」。通常会自动配置。

![](./images/debian-install-333368.webp)

4. 输入 DNS 服务器，然后点击「继续」。如何要配置多个 DNS 服务器，可以用「空格」隔开。

![](./images/debian-install-670686.webp)

5. 为你的 Debian 13 系统设置一个 `hostname` 主机名，然后点击「继续」。

![](./images/debian-install-920560.webp)

6. 如果你有与网络关联的特定「域名」，可以在这里输入。一般情况下，我们会选择「留空」。

![](./images/debian-install-704376.webp)

### 6. 设置 Root 密码

为`root`帐户设置一个强密码。

![](./images/debian-install-587634.webp)
...
![](./images/debian-install-669571.webp)

2. 为这个用户设置一个用户名，只能用小写字母和数字，而且必须以字母开头。

![](./images/debian-install-875373.webp)

3. 为新用户设置一个强密码，最好是和 `root` 密码不同。

![](./images/debian-install-416543.webp)
...
![](./images/debian-install-557392.webp)

选择你要分区的硬盘

![](./images/debian-install-327772.webp)

如果没有特殊需求，推荐选择「将所有文件放在同一个分区中」，你也可以将`/home`、`/var`和`/tmp`等目录单独分区。

![](./images/debian-install-755278.webp)

:::tip

这里如果硬盘不是空的，会提示下面内容，我们直接选择是即可。

![](./images/debian-install-709516.webp)

:::

选择「是」确认将修改写入磁盘并配置 LVM

![](./images/debian-install-802899.webp)

这里默认保持最大空间即可

![](./images/debian-install-555712.webp)

完成分区操作并将修改写入磁盘

![](./images/debian-install-940129.webp)

选择「是」确认将改动写入磁盘，然后点击「继续」。

![](./images/debian-install-602194.webp)

### 9. 开始安装基本系统

![](./images/debian-install-365668.webp)

### 配置软件包管理器：更新源

安装向导会询问你是否扫描额外的安装介质，选择「否」继续。

![](./images/debian-install-527438.webp)

选择「是」，启用网络镜像。（配置一个快速的国内源，对国内的小伙伴非常重要。）

![](./images/debian-install-285339.webp)

国家选择「中国」，Debian 仓库镜像站点推荐选择 `tsinghua` 清华源。

![](./images/debian-install-195050.webp)![](./images/debian-install-876653.webp)

如果你是直连网络，HTTP 代理信息就「留空」；如果有代理，就填写代理地址和端口号。

![](./images/debian-install-373349.webp)
...
![](./images/debian-install-369588.webp)
...
![](./images/debian-install-968123.webp)

选择完毕后，点击「继续」，开始安装这些软件。

![](./images/debian-install-278013.webp)

### 11. 安装 GRUB 启动引导器

选择「是」继续安装 GRUB 启动引导器。

![](./images/debian-install-135285.webp)

选择要安装 GRUB 的磁盘，比如`/dev/sda`，然后点击「继续」。

![](./images/debian-install-556969.webp)
