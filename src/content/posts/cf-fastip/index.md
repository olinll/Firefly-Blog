...
![添加外域路由](./images/af1123da-5854-4c78-8473-2e114d8107fa.png)
...
![外域域名CNAME到cf cdn域名去](./images/8df685bf-1fac-4f93-ba9b-998ac0dc6584.png)
...
我们先配置2个Tunnel，指向同一个服务，一个是作为SaaS 源服务器使用，一个是最终访问优选过的站点。如下图：

![创建Tunnel](./images/b0727af7-4503-42b4-848d-0d26e981182f.png)

上图中 `1.oi.cd` 作为SaaS源服务器使用，`2.oi.cd` 作为优选过的站点。

我们先将`2.oi.cd` 这个DNS记录删掉，注意！！ 这是需要到DNS记录里面删除，不要删除Tunnel！  
然后我们添加一条`2.oi.cd`的优选解析，最终如下图

![配置优选域名](./images/634a7949-c65e-4183-94de-882b11c79758.png)

下面我们点击到 SSL/TLS -> 自定义主机名（如果没有配置回退源，需要配置一个开启了小黄云的域名，再进行下面的操作）
添加一条自定义主机名配置
...
![](./images/76150513-a263-4d4f-970b-cc96fbdee221.png)
